...
function initialize() {
	...
	const BRITA_standard_water_filter = new storeItem(
		...
		'/img/brita_standard_water_filter.jpg'
	);
	...
	const BENSORTS_pillow_sandals = new storeItem(
		...
		'/img/BENSORTS_pillow_sandals.jpg'
	);
